...
<div><strong><p style="padding-top:20px;">NOS MENUS</p></strong></div>
</div>
...
<router-link class="btn" :to="{path : '/restaurateur/articleofmenu', query : {id_menu :Menu._id}}"><button class="btnDisplayArticle">Voir les articles</button>  
</router-link></div>
<div>
